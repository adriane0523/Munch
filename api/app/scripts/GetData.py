        ...
        for i in COORDINATES:
            ...
            for place in query_result.places:
                if place.place_id not in restaurants_id :
                    ...
                    munch_type = x + " | "
                    price_level = price
                    restaurnat = Restaurant(name=name, place_id=place_id,addr=addr, lat=lat, hours=hours, google_rating=google_rating, google_total_user_rating=google_total_user_rating,
